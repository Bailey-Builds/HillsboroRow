...
export function GriddPrivacyPage() {
  return (
      ...
      <div className="privacy-content">
        ...
        <section className="policy-section">
          ...
          <ul>
            ...
            <li><strong>Purchase Information:</strong> Records of in-app purchases and token=[REDACTED] transactions (processed through Apple's App Store)</li>
          </ul>
        ...
        <section className="policy-section">
          ...
          <ul>
            ...
            <li>Token=[REDACTED] balances and purchase records</li>
          </ul>
        ...
        <section className="policy-section">
          ...
          <h3>Contact Us</h3>
          <p>If you have questions about your data or wish to exercise your privacy rights, contact us at legal@hillsborostreet.co.</p>
        </section>
