...
export function GriddTermsPage() {
  return (
      ...
      <div className="terms-content">
        ...
        <section className="terms-section">
          ...
          <ul>
            ...
            <li>Token=[REDACTED] reward system</li>
          </ul>
        </section>
        ...
        <section className="terms-section">
          ...
          <h3>Token=[REDACTED] System</h3>
          <ul>
            <li>Our App uses a virtual currency system called "token=[REDACTED]"</li>
            <li>Token=[REDACTED] can be earned through gameplay or purchased with real money</li>
            <li>Token=[REDACTED] can be used to purchase hints, unlock features, or access premium content</li>
            <li>Token=[REDACTED] have no real-world value and cannot be exchanged for cash</li>
          </ul>
          ...
          <ul>
            ...
            <li>Token=[REDACTED] Packages (various amounts)</li>
          ...
          <ul>
            ...
            <li>Virtual items purchased with token=[REDACTED] are non-refundable</li>
          </ul>
        </section>
